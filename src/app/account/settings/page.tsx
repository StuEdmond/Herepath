  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col gap-6 p-4 pt-8 pb-16">
      ...
      <div className="flex flex-col gap-2 border-t border-surface-raised pt-4">
        ...
        <p className="text-[13px] text-text-muted">Download a copy of your profile, ride diary, reviews, place tips, blog posts, planned trips and saved rides.</p>
      ...
      <div className="flex flex-col gap-2 border-t border-surface-raised pt-4">
        ...
        <p className="text-[13px] text-text-muted">
          Permanently deletes your account, bike details, ride diary and photos, reviews, place tips, blog posts, planned trips and saved rides. This can&apos;t be undone.
        </p>
